...
public class PrincipalController implements Initializable {
    ...
    //Dueño
    @FXML
    TextField idDuenio, nombre1, nombre2, apellido1, apellido2, direccion, correo;
    //insertar Raza
    @FXML
    TextField insertarR;
    //veterinario
    ...
    public void insertarDuenio(ActionEvent event) {
        int id = Integer.parseInt(idDuenio.getText());
        ...
        Duenio objD = new Duenio(id, nombre1d, nombre2d, apellido1d, apellido2d, direcciond, correod);
        boolean b = ControlDuenio.insertarDuenio(objD);
        if (b) {
            JOptionPane.showMessageDialog(null, "Se han ingresado los datos", "Operacion Exitosa", JOptionPane.INFORMATION_MESSAGE);
            //0 --> YES
            //1 --> NO
            int r = JOptionPane.showConfirmDialog(null, "¿Desea agregar un telefono?", "Agregar Telefono", JOptionPane.YES_NO_OPTION);
            if (r == 0) {
                //insertar primer telefono
                idDuenioT.setText(Integer.toString(id));
                ingresarTelefonoDuenio(null);
    ...
    public void insertarTelefonoDuenio(ActionEvent event) {
        ...
        if (b) {
            ...
            //1 --> NO
            int r;
            r = JOptionPane.showConfirmDialog(null, "¿Desea agregar otro telefono?", "Agregar Telefono", JOptionPane.YES_NO_OPTION);
            if (r == 0) {
                numero.clear();
            } else {
                numero.clear();
